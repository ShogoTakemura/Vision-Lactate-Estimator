...
_COM_FEATURES = PROJECT_ROOT / "analyze_sensor" / "com_features"
...
# 処理対象のファイルリスト
target_files = [
    str(_COM_FEATURES / "squat01_correct_modelbase.csv"),
    str(_COM_FEATURES / "squat02_correct_modelbase.csv"),
    str(_COM_FEATURES / "squat03_correct_modelbase.csv"),
]
